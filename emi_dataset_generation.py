...
#%%
emi_pos_final_hidden_4R6A_1 = pd.read_csv("C:\\Users\\makow\\Documents\\GitHub\\UniRep\\emi_pos_finalhidden_4R6A_1.csv", header = 0, index_col = 0)
emi_pos_final_hidden_4R6A_2 = pd.read_csv("C:\\Users\\makow\\Documents\\GitHub\\UniRep\\emi_pos_finalhidden_4R6A_2.csv", header = 0, index_col = 0)
emi_pos_final_hidden_4R6A_3 = pd.read_csv("C:\\Users\\makow\\Documents\\GitHub\\UniRep\\emi_pos_finalhidden_4R6A_3.csv", header = 0, index_col = 0)
emi_pos_final_hidden_4R6A_4 = pd.read_csv("C:\\Users\\makow\\Documents\\GitHub\\UniRep\\emi_pos_finalhidden_4R6A_4.csv", header = 0, index_col = 0) 

emi_neg_final_hidden_4R6A_1 = pd.read_csv("C:\\Users\\makow\\Documents\\GitHub\\UniRep\\emi_neg_finalhidden_4R6A_1.csv", header = 0, index_col = 0)
emi_neg_final_hidden_4R6A_2 = pd.read_csv("C:\\Users\\makow\\Documents\\GitHub\\UniRep\\emi_neg_finalhidden_4R6A_2.csv", header = 0, index_col = 0)
#emi_neg_final_hidden_4R6A_3 = pd.read_csv("C:\\Users\\makow\\Documents\\GitHub\\UniRep\\emi_neg_finalhidden_4R6A_3.csv", header = 0, index_col = 0)

emi_final_hidden = pd.concat([emi_pos_final_hidden_4R6A_1, emi_pos_final_hidden_4R6A_2, emi_pos_final_hidden_4R6A_3, emi_pos_final_hidden_4R6A_4, emi_neg_final_hidden_4R6A_1, emi_neg_final_hidden_4R6A_2], axis = 0)
emi_final_hidden.to_csv('emi_final_hidden_4R6A.csv', header = True, index = True)
