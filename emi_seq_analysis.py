...
emi_pos_seq_stringent.iloc[0:500,0].to_csv('emi_pos_seqs_1R5A_1.txt', header = False, index = False)
emi_neg_seq_stringent.iloc[0:500,0].to_csv('emi_neg_seqs_1R5A_1.txt', header = False, index = False)

emi_pos_seq_stringent.iloc[500:1000,0].to_csv('emi_pos_seqs_1R5A_2.txt', header = False, index = False)
emi_neg_seq_stringent.iloc[500:1000,0].to_csv('emi_neg_seqs_1R5A_2.txt', header = False, index = False)

emi_pos_seq_stringent.iloc[1000:1500,0].to_csv('emi_pos_seqs_1R5A_3.txt', header = False, index = False)
emi_neg_seq_stringent.iloc[1000:1500,0].to_csv('emi_neg_seqs_1R5A_3.txt', header = False, index = False)
