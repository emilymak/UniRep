...
#%%
lenzi_rep1_antigen_pos = pd.read_csv("C:\\Users\\makow\\Documents\\GitHub\\UniRep\\lenzi_rep1_antigen_pos_1nm_seqs.csv", header = None, index_col = 0)
lenzi_rep1_antigen_pos.columns = ['rep1']
lenzi_rep1_psr_pos = pd.read_csv("C:\\Users\\makow\\Documents\\GitHub\\UniRep\\lenzi_rep1_psr_pos_seqs.csv", header = None)
lenzi_rep1_psr_neg = pd.read_csv("C:\\Users\\makow\\Documents\\GitHub\\UniRep\\lenzi_rep1_psr_neg_seqs.csv", header = None)
...
#%%
lenzi_rep1_pos = pd.concat([lenzi_rep1_psr_pos, lenzi_rep1_ova_pos], axis = 0, ignore_index = False)
lenzi_rep1_neg = pd.concat([lenzi_rep1_psr_neg, lenzi_rep1_ova_neg], axis = 0, ignore_index = False)
...
lenzi_rep1_pos_duplicates_psr = lenzi_rep1_pos[lenzi_rep1_pos.duplicated([0], keep = 'last')]
lenzi_rep1_pos_duplicates_psr.index = lenzi_rep1_pos_duplicates_psr.iloc[:,0]
lenzi_rep1_neg_duplicates_psr = lenzi_rep1_neg[lenzi_rep1_neg.duplicated([0], keep = 'last')]
lenzi_rep1_neg_duplicates_psr.index = lenzi_rep1_neg_duplicates_psr.iloc[:,0]

lenzi_rep1_pos_duplicates = pd.concat([lenzi_rep1_pos_duplicates_ova, lenzi_rep1_pos_duplicates_psr], axis = 1, ignore_index = False)
lenzi_rep1_neg_duplicates = pd.concat([lenzi_rep1_neg_duplicates_ova, lenzi_rep1_neg_duplicates_psr], axis = 1, ignore_index = False)

#%%
lenzi_rep2_antigen_pos = pd.read_csv("C:\\Users\\makow\\Documents\\GitHub\\UniRep\\lenzi_rep2_antigen_pos_1nm_seqs.csv", header = None, index_col = 0)
lenzi_rep2_antigen_pos.columns = ['rep2']
lenzi_rep2_psr_pos = pd.read_csv("C:\\Users\\makow\\Documents\\GitHub\\UniRep\\lenzi_rep2_psr_pos_seqs.csv", header = None)
lenzi_rep2_psr_neg = pd.read_csv("C:\\Users\\makow\\Documents\\GitHub\\UniRep\\lenzi_rep2_psr_neg_seqs.csv", header = None)
...
#%%
lenzi_rep2_pos = pd.concat([lenzi_rep2_psr_pos, lenzi_rep2_ova_pos], axis = 0, ignore_index = False)
lenzi_rep2_neg = pd.concat([lenzi_rep2_psr_neg, lenzi_rep2_ova_neg], axis = 0, ignore_index = False)
...
lenzi_rep2_pos_duplicates_psr = lenzi_rep2_pos[lenzi_rep2_pos.duplicated([0], keep = 'last')]
lenzi_rep2_pos_duplicates_psr.index = lenzi_rep2_pos_duplicates_psr.iloc[:,0]
lenzi_rep2_neg_duplicates_psr = lenzi_rep2_neg[lenzi_rep2_neg.duplicated([0], keep = 'last')]
lenzi_rep2_neg_duplicates_psr.index = lenzi_rep2_neg_duplicates_psr.iloc[:,0]

lenzi_rep2_pos_duplicates = pd.concat([lenzi_rep2_pos_duplicates_ova, lenzi_rep2_pos_duplicates_psr], axis = 1, ignore_index = False)
lenzi_rep2_neg_duplicates = pd.concat([lenzi_rep2_neg_duplicates_ova, lenzi_rep2_neg_duplicates_psr], axis = 1, ignore_index = False)
...
#%%
lenzi_pos_duplicates.columns = ['Sequences', 'OVA Freq', 'Drop', 'PSR Freq']
lenzi_neg_duplicates.columns = ['Sequences', 'OVA Freq', 'Drop', 'PSR Freq']

lenzi_pos_duplicates['Frequency Ave'] = (((lenzi_pos_duplicates['OVA Freq']-min(lenzi_pos_duplicates['OVA Freq']))/(max(lenzi_pos_duplicates['OVA Freq'])-min(lenzi_pos_duplicates['OVA Freq']))) + ((lenzi_pos_duplicates['PSR Freq']-min(lenzi_pos_duplicates['PSR Freq']))/(max(lenzi_pos_duplicates['PSR Freq'])-min(lenzi_pos_duplicates['PSR Freq']))))/2
lenzi_neg_duplicates['Frequency Ave'] = (((lenzi_neg_duplicates['OVA Freq']-min(lenzi_neg_duplicates['OVA Freq']))/(max(lenzi_neg_duplicates['OVA Freq'])-min(lenzi_neg_duplicates['OVA Freq']))) + ((lenzi_neg_duplicates['PSR Freq']-min(lenzi_neg_duplicates['PSR Freq']))/(max(lenzi_neg_duplicates['PSR Freq'])-min(lenzi_neg_duplicates['PSR Freq']))))/2
...
#%%
lenzi_pos_seqs = lenzi_seqs.iloc[0:2902,:]
lenzi_pos_seqs_char = []
...
lenzi_neg_seqs = lenzi_seqs.iloc[2902:15667,:]
lenzi_neg_seqs_char = []
...
lenzi_pos_seq.columns = ['Sequences', 'OVA Freq', 'PSR Freq', 'Frequency Ave']
...
lenzi_neg_seq.columns = ['Sequences', 'OVA Freq', 'PSR Freq', 'Frequency Ave']
...
lenzi_pos_seq.columns = ['Sequences', 'OVA Freq', 'PSR Freq', 'Frequency Ave', 'PSY Binding', 'rep1', 'rep2']
lenzi_neg_seq.sort_values(by = 'Frequency Ave', ascending = False, inplace = True)
lenzi_neg_seq.reset_index(drop = False, inplace = True)
lenzi_neg_seq.columns = ['Sequences', 'OVA Freq', 'PSR Freq', 'Frequency Ave', 'PSY Binding', 'rep1', 'rep2']
...
lenzi_seqs_used_stringent.drop('PSR Freq', inplace = True, axis = 1)
...
lenzi_pos_seq_stringent.iloc[0:500,0].to_csv('lenzi_pos_seqs_10Y_1.txt', header = False, index = False)
lenzi_neg_seq_stringent.iloc[0:500,0].to_csv('lenzi_neg_seqs_10Y_1.txt', header = False, index = False)

lenzi_pos_seq_stringent.iloc[500:1000,0].to_csv('lenzi_pos_seqs_10Y_2.txt', header = False, index = False)
lenzi_neg_seq_stringent.iloc[500:1000,0].to_csv('lenzi_neg_seqs_10Y_2.txt', header = False, index = False)

lenzi_pos_seq_stringent.iloc[1000:1500,0].to_csv('lenzi_pos_seqs_10Y_3.txt', header = False, index = False)
lenzi_neg_seq_stringent.iloc[1000:1500,0].to_csv('lenzi_neg_seqs_10Y_3.txt', header = False, index = False)

lenzi_pos_seq_stringent.iloc[1500:2000,0].to_csv('lenzi_pos_seqs_10Y_4.txt', header = False, index = False)
lenzi_neg_seq_stringent.iloc[1500:2000,0].to_csv('lenzi_neg_seqs_10Y_4.txt', header = False, index = False)
