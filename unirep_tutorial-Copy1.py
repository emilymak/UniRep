...
sequences = []
with open("emi_neg_seqs_0Y_1.txt", "r") as source:
...
average_hidden_pd.to_csv("emi_neg_reps_0Y_1.csv")
final_hidden_pd.to_csv("emi_neg_finalhidden_0Y_1.csv")
