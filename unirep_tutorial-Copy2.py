...
sequences = []
with open("emi_pos_seqs_2R_2.txt", "r") as source:
...
average_hidden_pd.to_csv("emi_pos_reps_2R_2.csv")
final_hidden_pd.to_csv("emi_pos_finalhidden_2R_2.csv")
