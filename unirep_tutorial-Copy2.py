...
sequences = []
with open("lenzi_pos_seqs_4.txt", "r") as source:
...
average_hidden_pd.to_csv("lenzi_pos_reps_4.csv")
final_hidden_pd.to_csv("lenzi_pos_finalhidden_4.csv")
