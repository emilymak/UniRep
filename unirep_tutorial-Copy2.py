...
sequences = []
with open("emi_neg_seqs_1R5A_2.txt", "r") as source:
...
average_hidden_pd.to_csv("emi_neg_reps_1R5A_2.csv")
final_hidden_pd.to_csv("emi_neg_finalhidden_1R5A_2.csv")
