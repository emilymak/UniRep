...
sequences = []
with open("lenzi_pos_seqs_2.txt", "r") as source:
...
average_hidden_pd.to_csv("lenzi_pos_reps_2.csv")
final_hidden_pd.to_csv("lenzi_pos_finalhidden_2.csv")
