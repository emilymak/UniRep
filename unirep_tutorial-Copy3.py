...
sequences = []
with open("emi_neg_seqs_3R_3.txt", "r") as source:
...
average_hidden_pd.to_csv("emi_neg_reps_3R_3.csv")
final_hidden_pd.to_csv("emi_neg_finalhidden_3R_3.csv")
