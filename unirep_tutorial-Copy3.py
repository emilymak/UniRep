...
sequences = []
with open("lenzi_pos_seqs_3.txt", "r") as source:
...
average_hidden_pd.to_csv("lenzi_pos_reps_3.csv")
final_hidden_pd.to_csv("lenzi_pos_finalhidden_3.csv")
