...
sequences = []
with open("emi_pos_seqs_0Y_3.txt", "r") as source:
...
average_hidden_pd.to_csv("emi_pos_reps_0Y_3.csv")
final_hidden_pd.to_csv("emi_pos_finalhidden_0Y_3.csv")
