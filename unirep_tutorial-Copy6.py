...
sequences = []
with open("emi_novel_clones_seqs.txt", "r") as source:
...
average_hidden_pd.to_csv("emi_novel_clones_reps.csv")
final_hidden_pd.to_csv("emi_novel_clones_finalhidden.csv")
...
data_name = 'emi_novel_clones_reps'
file_append = '.pickle'
