...
sequences = []
with open("emi_neg_seqs_ova_4.txt", "r") as source:
...
average_hidden_pd.to_csv("emi_neg_reps_ova_4.csv")
final_hidden_pd.to_csv("emi_neg_finalhidden_ova_4.csv")
