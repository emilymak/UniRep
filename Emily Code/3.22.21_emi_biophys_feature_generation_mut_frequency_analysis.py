...
emi_seq = pd.read_csv("C:\\Users\\makow\\Documents\\GitHub\\UniRep\\Datasets\\seqs\\emi_R6_seqs.csv", header = 0, index_col = 0)
...
#%%
#mutations_biophys.to_csv('emi_R9_biophys.csv', header = True, index = False)
#mutations.to_csv('seqs_mutations.csv', header = True, index = True)


#%%
mut_counts_0 = mutations[0].value_counts().sort_values(ascending = False)/4000
mut_counts_1 = mutations[1].value_counts().sort_values(ascending = False)/4000
mut_counts_2 = mutations[2].value_counts().sort_values(ascending = False)/4000
mut_counts_3 = mutations[3].value_counts().sort_values(ascending = False)/4000
mut_counts_4 = mutations[4].value_counts().sort_values(ascending = False)/4000
mut_counts_5 = mutations[5].value_counts().sort_values(ascending = False)/4000
mut_counts_6 = mutations[6].value_counts().sort_values(ascending = False)/4000
mut_counts_7 = mutations[7].value_counts().sort_values(ascending = False)/4000

mut_counts = pd.concat([mut_counts_0, mut_counts_1, mut_counts_2, mut_counts_3, mut_counts_4, mut_counts_5, mut_counts_6, mut_counts_7], axis = 1, ignore_index = False)
