...
#%%
emi_reps = pd.read_csv("C:\\Users\\makow\\Documents\\GitHub\\UniRep\\Datasets\\emi_reps_7Y.csv", header = 0, index_col = 0)
emi_labels = pd.read_csv("C:\\Users\\makow\\Documents\\GitHub\\UniRep\\Datasets\\emi_rep_labels_7Y.csv", header = 0, index_col = 0)
...
print(accuracy_score(emi_iso_ant_predict_7NotY.iloc[:,0], emi_iso_binding_7NotY.iloc[:,3]))
...
print(accuracy_score(emi_iso_psy_predict_7NotY.iloc[:,0], emi_iso_binding_7NotY.iloc[:,4]))
