...
#%%
emi_R4_rep1_ova_antigen_pos = pd.read_csv("C:\\Users\\makow\\Documents\\GitHub\\UniRep\\Datasets\\seqs\\emi_R5_rep1_ova_neg_ant_pos_seqs.csv", header = None, index_col = 0)
emi_R4_rep1_ova_antigen_pos.columns = ['Orep1']
emi_R4_rep1_psr_antigen_pos = pd.read_csv("C:\\Users\\makow\\Documents\\GitHub\\UniRep\\Datasets\\seqs\\emi_R5_rep1_psr_neg_ant_pos_seqs.csv", header = None, index_col = 0)
emi_R4_rep1_psr_antigen_pos.columns = ['Prep1']
...
#%%
emi_R4_rep2_ova_antigen_pos = pd.read_csv("C:\\Users\\makow\\Documents\\GitHub\\UniRep\\Datasets\\seqs\\emi_R5_rep2_ova_neg_ant_pos_seqs.csv", header = None, index_col = 0)
emi_R4_rep2_ova_antigen_pos.columns = ['Orep2']
emi_R4_rep2_psr_antigen_pos = pd.read_csv("C:\\Users\\makow\\Documents\\GitHub\\UniRep\\Datasets\\seqs\\emi_R5_rep2_psr_neg_ant_pos_seqs.csv", header = None, index_col = 0)
emi_R4_rep2_psr_antigen_pos.columns = ['Prep2']
...
emi_ant = pd.concat([emi_R4_rep1_ova_antigen_pos, emi_R4_rep1_psr_antigen_pos, emi_R4_rep2_ova_antigen_pos, emi_R4_rep2_psr_antigen_pos], axis = 1)
...
emi_pos_seq.columns = ['Sequences', 'PSR Freq1', 'OVA Freq1', 'PSR Freq2', 'OVA Freq2', 'Frequency Ave', 'PSY Binding', 'Orep1', 'Prep1', 'Orep2', 'Prep2']
emi_neg_seq.sort_values(by = 'Frequency Ave', ascending = False, inplace = True)
emi_neg_seq.reset_index(drop = False, inplace = True)
emi_neg_seq.columns = ['Sequences', 'PSR Freq1', 'OVA Freq1', 'PSR Freq2', 'OVA Freq2', 'Frequency Ave', 'PSY Binding', 'Orep1', 'Prep1', 'Orep2', 'Prep2']
...
for index, row in emi_pos_seq_stringent.iterrows():
    if 1 < sum(row[7:11].isna()) < 4:
        emi_pos_seq_stringent.loc[index,'ANT Binding'] = 2
    if sum(row[7:11].isna()) < 2:
...
emi_seqs_used_stringent.drop('Prep1', inplace = True, axis = 1)
emi_seqs_used_stringent.drop('Prep2', inplace = True, axis = 1)
...
"""
emi_pos_seq_stringent.iloc[0:2000,0].to_csv('emi_R4_pos_seqs.txt', header = False, index = False)
emi_neg_seq_stringent.iloc[0:2000,0].to_csv('emi_R4_neg_seqs.txt', header = False, index = False)

emi_pos_seq_stringent.iloc[500:1000,0].to_csv('emi_R4_pos_seqs_5NotA_2.txt', header = False, index = False)
emi_neg_seq_stringent.iloc[500:1000,0].to_csv('emi_R4_neg_seqs_5NotA_2.txt', header = False, index = False)

emi_pos_seq_stringent.iloc[1000:1500,0].to_csv('emi_R4_pos_seqs_5NotA_3.txt', header = False, index = False)
emi_neg_seq_stringent.iloc[1000:1500,0].to_csv('emi_R4_neg_seqs_5NotA_3.txt', header = False, index = False)

emi_pos_seq_stringent.iloc[1500:2000,0].to_csv('emi_R4_pos_seqs_5NotA_4.txt', header = False, index = False)
emi_neg_seq_stringent.iloc[1500:2000,0].to_csv('emi_R4_neg_seqs_5NotA_4.txt', header = False, index = False)
