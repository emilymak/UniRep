...
lenzi_reps = pd.concat([lenzi_pos_reps_1, lenzi_pos_reps_2, lenzi_pos_reps_3, lenzi_neg_reps_1, lenzi_neg_reps_2, lenzi_neg_reps_3, lenzi_neg_reps_4], axis = 0)
...
lenzi_finalhidden = pd.concat([lenzi_pos_finalhidden_1, lenzi_pos_finalhidden_2, lenzi_pos_finalhidden_3, lenzi_neg_finalhidden_1, lenzi_neg_finalhidden_2, lenzi_neg_finalhidden_3, lenzi_neg_finalhidden_4], axis = 0)
