...
#%%
plt.scatter(ant_transforms.iloc[:,1], ant_transforms.iloc[:,0])
plt.scatter(ant_transforms.iloc[:,2], ant_transforms.iloc[:,1])


#%%
plt.scatter(iso_transform_0Y.iloc[0,0], iso_transform_0Y.iloc[1,0])
