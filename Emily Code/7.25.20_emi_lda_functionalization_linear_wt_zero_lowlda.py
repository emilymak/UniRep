...
chosen_l = [514, 1325, 492, 619, 134, 568, 479, 581, 1225, 659, 1397, 471, 1977, 910, 1089, 1677, 1686, 308, 839, 1786, 1851, 1317, 2587]
...
#%%
emi_IgG_corr_df = pd.concat([emi_IgG_binding.iloc[:,1:4], emi_IgG_biophys], axis = 1)
emi_IgG_corr = emi_IgG_corr_df.corr(method = 'spearman')
sns.heatmap(emi_IgG_corr.iloc[:,0:4], annot = True)
...
#%%
emi_IgG_mutation_corr = pd.read_csv("C:\\Users\\makow\\Documents\\Research\\Manuscripts\\2020 Emi Specificity\\1.14.21_emi_IgG_mutation_analysis_corr_df.csv", header = 0, index_col = 0)

plt.figure(figsize = (12,10))
sns.heatmap(emi_IgG_mutation_corr, cmap = 'magma', linewidth = 0.25, linecolor = 'k', square = True)


#%%
emi_IgG_mutation_corr = pd.read_csv("C:\\Users\\makow\\Documents\\Research\\Manuscripts\\2020 Emi Specificity\\1.14.21_emi_IgG_mutation_analysis_moe_corr_df.csv", header = 0, index_col = 0)
...
#%%
nine_mr = pd.read_csv("C:\\Users\\makow\\Documents\\GitHub\\UniRep\\Datasets\\Emi_newvariants_9mer_v2.csv", header = 0, index_col = 0)
emi_IgG_nine_mr = pd.read_csv("C:\\Users\\makow\\Documents\\GitHub\\UniRep\\Datasets\\2.2.21_emi_IgG_humanness.csv", header = 0, index_col = 0)

fig = plt.figure()
ax = fig.add_subplot(111, projection='3d')

ax.scatter(emi_ant_transform.iloc[:,0], emi_psy_transform.iloc[:,0], nine_mr.iloc[1:4002,1], c = nine_mr.iloc[1:4002,1], cmap = 'plasma')
ax.scatter(emi_IgG_ant_transform.iloc[:,0], emi_IgG_psy_transform.iloc[:,0], emi_IgG_nine_mr.iloc[:,2], s = 45, c = 'k')
