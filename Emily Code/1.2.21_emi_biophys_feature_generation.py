...
emi_seq = pd.read_csv("C:\\Users\\makow\\Documents\\GitHub\\UniRep\\Datasets\\seqs\\emi_IgG_seqs.txt", header = None, index_col = None)
...
#%%
mutations_biophys.to_csv('emi_IgG_biophys.csv', header = True, index = False)
